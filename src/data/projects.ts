...
export const GROUPS: ProjectGroup[] = [
	{
		...
		projects: [
			...
			},
			{
				...
				hero: 'ai-conversation-hero.svg',
				tagline:
					'An all-in-one AI conversation service for .NET — text, push-to-talk, and hands-free wake-word chat with history that the model can search.',
				highlights: [
					'Text chat and push-to-talk voice',
					'Hands-free wake word activation',
					'Audio feedback cues',
					'Persistent history with AI self-lookup',
					'Observable state management',
				],
				tags: ['AI', 'MAUI', 'Blazor', 'ASP.NET'],
			},
		],
	},
	{
		...
		projects: [
			...
			},
			{
				...
				repo: 'shinyorg/speech',
				docs: 'https://shinylib.net/speech/',
				hero: 'projects/speech-hero.svg',
				tagline:
					'Speech-to-text, text-to-speech, capture and playback for .NET MAUI and Blazor WebAssembly.',
				highlights: ['On-device and cloud recognition', 'Azure AI Speech & ElevenLabs', 'Audio capture and playback'],
				tags: ['MAUI', 'Blazor', 'AI'],
			},
			{
				name: 'Music',
