...
description: 'A pure .NET MAUI TableView control with 15 cell types, cascading styles, drag-sort, dynamic sections, and full MVVM support — no custom renderers required'
pubDate: 'Feb 21 2026'
heroImage: '../../assets/shiny-maui-tableview-hero.svg'
tags: ['Shiny', '.NET MAUI', 'UI Controls']
---
