...
Full documentation at [shinylib.net](https://shinylib.net/extensions/sqlite-document-db/) and the [GitHub repository](https://github.com/shinyorg/SqliteDocumentDb) has the complete README with benchmarks, expression reference tables, and examples.
