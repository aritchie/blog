...
That's it.  The service registers `IAiConversationService` with all the wiring — speech services from [Shiny.Speech](https://shinylib.net/speech), chat completions from [Microsoft.Extensions.AI](https://www.nuget.org/packages/Microsoft.Extensions.AI), audio playback, time provider, and optional message persistence.
