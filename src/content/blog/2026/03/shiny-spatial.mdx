...
description: 'A new library that turns SQLite into a spatial database with R*Tree indexing, custom geometry algorithms, polygon-based GPS geofencing with no OS region limits — zero native dependencies, fully AOT-compatible'
pubDate: 'Mar 01 2026'
heroImage: '../../../../assets/shiny-spatial-hero.svg'
tags: ['Shiny', '.NET', 'Geospatial', 'SQLite']
---
