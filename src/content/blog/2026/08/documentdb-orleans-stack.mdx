...
Reporting, dashboards, admin tooling and bulk inspection — the jobs that don't need a grain's guarantees and
shouldn't pay for them — become plain document queries.
