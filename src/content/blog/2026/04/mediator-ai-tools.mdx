...
description: 'Write a single C# record and have it automatically become a fully typed AI tool — with zero adapter code. Shiny Mediator 6.3 delivers contract-first source generation for AI tools, HTTP clients, and ASP.NET endpoints.'
pubDate: 'Apr 28 2026'
heroImage: '../../../../assets/mediator-ai-tools-hero.svg'
tags: ['Shiny', '.NET', 'AI', 'Mediator', 'Source Generators', 'Microsoft.Extensions.AI']
---
...
Check out the [Sample.CopilotConsole](https://github.com/shinyorg/mediator/tree/main/samples/Sample.CopilotConsole) for a working example that wires up AI tools with a chat loop, or browse the [Shiny Mediator documentation](https://shinylib.net/mediator/) for the full setup guide.
