...
description: 'Shiny.DocumentDb.Extensions.AI turns your document store into a set of LLM-callable tools. Register types, set capabilities, and let the agent query, insert, update, and delete documents through natural language.'
pubDate: 'Apr 30 2026'
heroImage: '../../../../assets/documentdb-ai-tools-hero.svg'
tags: ['Shiny', '.NET', 'AI', 'Document DB', 'Microsoft.Extensions.AI', 'SQLite']
---
...
The [repository](https://github.com/shinyorg/DocumentDb) includes a `Sample.CopilotConsole` project that authenticates with GitHub Copilot and starts an interactive chat session. The LLM can query customers, create orders, compute aggregates — all through the registered AI tools. Try it:
...
Check the [full documentation](https://shinylib.net/documentdb/ai-tools/) for the API reference and the [release notes](https://shinylib.net/documentdb/release-notes/) for the complete v4.0 changelog.
