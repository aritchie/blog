...
description: 'A new library that provides a unified API for browsing, searching, and playing music from the device music library on iOS and Android — with permissions, metadata, playback controls, and file export'
pubDate: 'Mar 01 2026'
heroImage: '../../assets/shiny-music-hero.svg'
tags: ['Shiny', '.NET MAUI', 'Media']
---
